...
do
	...
	yarn jar target/tpcds-gen-1.0-SNAPSHOT.jar -d o3fs://bucket1.vol1.$OZONE_SERVICE_ID/o3_${s} -p 100 -s ${s}
	cd ../..
	...
	impala-shell -f impala-external-o3-${s}gb.sql
	impala-shell -f impala-parquet-o3-${s}gb.sql
	impala-shell -f impala-insert-o3-${s}gb.sql
done
